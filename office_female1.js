...
function userClickButton() {
	var userData = document.getElementById("inputField").value;
	console.log("speachText3="+userData);
	userData = "data="+userData;
	
	fetch('./requestPost.php', {
	 method: 'POST',
	 headers: {
	 'Content-Type': 'application/x-www-form-urlencoded; charset=UTF-8'
	 },
	 body: "action=userdata&"+userData
	  })
...
function doPostReqest(actionName) {
...
function prepareExternalInterface(app) {
    ...
    // }
	app.ExternalInterface.saySmt1 = function(actionName) {
		doPostReqest(actionName);	
	}
	...
	//console.log("speachText2="+speachText);
     window.speechSynthesis.speak(speech);
     }
}
